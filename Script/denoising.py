...
from Denoising.CNN_based.xnet import xnet as denoise
...
def post_exper(img_name):  # img_name: 612.png
    ...
    deg_img_path = os.path.join('/mnt/jixie8t/zd_new/Code/RetinexD/Images/I/I_1', img_name)
    deg_S_path = os.path.join('/mnt/jixie8t/zd_new/Code/RetinexD/Images/S/S_1', img_name)
    deg_E_path = os.path.join('/mnt/jixie8t/zd_new/Code/RetinexD/Images/E/E_1', img_name)
    ...
    enh_img = denoise(deg_S, 1) * deg_E
    save_img(enh_img, 'post_xnet.png')
